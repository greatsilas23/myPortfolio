...
function ComplimentaryEquation(props){
    const styles = {
      myListItemOne: {
          minWidth: '300px',
          maxWidth: '300px',
    ...
    return(
        <div>
            <center>
                <h1 style={{ color: 'black', fontSize: '13'}}>Complimentary Equation</h1>
            </center>
            <hr/>
            <div>
                <center>
                        ...
                        <tr>
                            <td style={styles.myTd}>
                                <ol>
                                    ...
                                    <hr/>
                                    <li  style={styles.myListItemOne}>&Alpha; {props.alphaProp} &Beta; {props.betaProp}</li>
                            ...
                            <td style={styles.myTd}>
                                <ol>
                                    ...
                                    <hr/>
                                    <li  style={styles.myListItemOne}>y<sub>p</sub> = A<sub>1</sub>e<sup>{props.alphaProp}x</sup> + A<sub>2</sub>e<sup>{props.betaProp}x</sup></li>
...
export default ComplimentaryEquation